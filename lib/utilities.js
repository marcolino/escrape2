...
var diff = resemble("../public/test/meb1.jpg").compareTo("../public/test/meb1.jpg").ignoreColors().onComplete(function(data) {
  console.log(data);
    / *
    {
...
var api = r.resemble("../public/images/test/meb1.jpg").compareTo("../public/images/test/meb1.jpg").onComplete(function(data) {
    console.log(data);
    / *
    {
      red: 255,
