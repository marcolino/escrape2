...
/*
router.route('/').get(getRoot(req, res, next));
router.route('/').post(postRoot(req, res));

function getRoot(req, res, next) { // GET all persons
...
function postRoot(req, res) { // POST a new person
